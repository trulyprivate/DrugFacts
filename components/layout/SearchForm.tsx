  ...
  return (
    <form onSubmit={handleSearch} className="relative" role="search">
      <label htmlFor="drug-search" className="sr-only">
        Search for drug information by name, generic name, or medical indication
      </label>
      <Input
        id="drug-search"
        type="text"
        ...
        onFocus={handleFocus}
        onBlur={handleBlur}
        aria-label="Search for drug information by name, generic name, or medical indication"
      ...
      />
      <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 text-medical-gray-400 h-4 w-4" aria-hidden="true" />
    </form>
  );
}