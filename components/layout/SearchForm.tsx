  ...
  return (
    <form onSubmit={handleSearch} className="relative" role="search">
      ...
      <Input
        ...
        className={`transition-all duration-300 ease-in-out pl-8 pr-4 py-2 border border-medical-gray-300 rounded-lg focus:ring-2 focus:ring-medical-blue focus:border-transparent ${
